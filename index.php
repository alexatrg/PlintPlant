...
<body>
        ...
        <div class="container">
            ...
            <div id="navbarcollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="partner.php" class="nav-link active">Our Partner</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- Section Atas -->
    <section style="background: url(images/main.jpg) no-repeat;" class="hero d-flex align-items-center">
        <div class="container">
            <p class="small-text-hero"><i class="icon-localizer text-primary mr-1"></i>Berbagai jenis <span
                    class="text-primary">tumbuhan </span> tersedia</p>
            <h1>Temukan <span class="text-primary">tumbuhan </span> yang anda cari</h1>
            <p class="text-hero">Dibagi berdasarkan 13 kategori yang berbeda</p>
            <div class="search-bar">
                <form action="#" method="POST">
                    <div class="row">
                        <div class="form-group col-lg-10">
                            <input type="search" name="search" placeholder="Apa yang anda cari?">
                        </div>
                        <div class="form-group col-lg-2">
                            <input type="submit" value="Cari" class="submit" name="submit">
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <h4 class="h5">140 Tanaman</h4>
                </div>
                <div class="col-sm-3">
                    <div class="icon"><i class="fa fa-plus-square"></i></div>
                    <h4 class="h5">13 Kategori</h4>
                </div>
                <div class="col-sm-3">
                    <div class="icon"><i class="fa fa-industry"></i></div>
                    <h4 class="h5">43 Industri</h4>
                </div>
                <div class="col-sm-3">
                    <div class="icon"><i class="fa fa-wheelchair-alt"></i></div>
                    <h4 class="h5">60 Manfaat</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="latest-listings">
        <div class="container">
            <header>
                <h2 class="has-lines"><small>Kategori Tumbuhan</small> Cari Tumbuhan Berdasarkan Kategori</h2>
                <p class="lead">Tersedia data tumbuhan yang dibagi menjadi 13 bagian</p>
            </header>
            <div class="owl-carousel owl-theme latest-listings-slider">
                <?php include_once './endpoint/carousel.php'?>
            </div>
        </div>
    </section>
