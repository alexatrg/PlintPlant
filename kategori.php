...
<body>
    ...
    <section style="background: url(images/main.jpg) no-repeat;" class="hero d-flex align-items-center">
        <div class="container">
            <?php $kategori = $_GET['kategori'];
                    ...
                    $kat = $kategori[1]." ".$kategori[2];
                echo '<h1>Kategori <span class="text-primary">tumbuhan </span> '; echo $kat; echo '</h1>';
            ?>
        </div>
    </section>
    ...
    <section class="latest-listings">
        <div class="container">
            <header>
                <h2 class="has-lines"><small>Daftar Tumbuhan</small> Berdasarkan Kategori <?= $_GET['kategori']; ?></h2>
            </header>
            <div class="row">
                <?php include_once './endpoint/list.php' ?>
            </div>
        </div>
    </section>
