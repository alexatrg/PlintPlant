...
<head>
    <!-- Title dan Icon -->
    <title id="myTitle">Profil - PlintPlant</title>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $query = "UPDATE user SET nama='$nama', nope='$nope', password='$password' WHERE username='$username'";
        $statement_update = $dbConn->prepare($query);
        if ($statement_update->execute()) {
            $msg_succ = "Profil berhasil di update";
        } else {
    ...
    <script>
        function profil() {
            document.getElementById("myTitle").innerHTML = "Profil - PlintPlant";
        }

        function edit() {
            document.getElementById("myTitle").innerHTML = "Edit Profil - PlintPlant";
        }
    </script>
</head>
...
<body>
            ...
            <div class="content-holder d-flex justify-content-between">
                <div class="info d-flex">
                    <div class="contact d-flex">
                        <p><a href="mailto:plintplant@company.com" target="blank"><i class="fa fa-envelope-o text-success"></i><span class="d-none d-md-inline">plintplant@company.com</span></a></p>
                        <p><a href="https://api.whatsapp.com/send?phone=6282173154102" target="blank"><i class="fa fa-phone text-success"></i><span class="d-none d-md-inline">+62
                                    821-731-541-02</span></a></p>
                    </div>
                </div>
                <div class="CTAs">
                    <a href="masuk.php" class="login"><i class="fa fa-sign-in"></i><span class="d-none d-md-inline ">Masuk</span></a>
                    <a href="daftar.php" class="login"> <i class="fa fa-user"></i><span class="d-none d-md-inline">Daftar</span></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div id="navbarcollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a id="navbarDropdownMenuLink" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Kategori</a>
                        <div aria-labelledby="navbarDropdownMenuLink" class="dropdown-menu">
                            <a href="Sesuatu.html" class="dropdown-item">Tanaman Obat</a>
                            <a href="Sesuatu.html" class="dropdown-item">Tanaman Hias</a>
                            <a href="Sesuatu.html" class="dropdown-item">Tanaman Industri</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <!-- Section Daftar -->
    <section style="background: url(images/main.jpg) no-repeat;" class="hero d-flex align-items-center py-1">
        <form action="profil.php" method="post" enctype="multipart/form-data">
            <div class="container my-3">
                <?php
                if (!empty($msg_succ)) {
                    echo '<script>alert("' . $msg_succ . '")</script>';
                ...
                <div class="row m-y-2">
                    <div class="col-lg-8 push-lg-4">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a href="" data-target="#profile" data-toggle="tab" class="nav-link active hide" onclick="profil();">Profil</a>
                            </li>
                            <li class="nav-item">
                                <a href="" data-target="#edit" data-toggle="tab" class="nav-link show" onclick="edit();">Edit</a>
                            </li>
                        </ul>
                        <div class="tab-content pb-3">
                            <div class="tab-pane active" id="profile">
                                <h4 class="mt-2 mb-4">Profil Pengguna</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5>Nama</h5>
                                        <p>
                            ...
                            <div class="tab-pane" id="edit">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label form-control-label">No. Handphone</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" type="text" name="nope" value="<?= $data['nope']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <input class="btn btn-primary text-uppercase" type="submit" name="simpan" value="Simpan">
                                    <input class="btn btn-secondary text-uppercase" type="reset" value="Batal">
                                </div>
                            </div>
                        </div>
                    </div>
