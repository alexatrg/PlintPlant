...
<head>
    ...
    if (isset($_POST["daftar"])) {
        $query = "INSERT INTO user (nama, username, password, nope) VALUES(:nama, :username, :password, :nope)";
        ...
        $msg = "Data anda telah direkam. Silahkan Masuk!";
    }
    ?>
</head>
            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            <h5 class="card-title text-center text-dark">Daftar PlintPlant</h5>
                            <form class="form-signin" action="daftar.php" method="post">
                                <?php
                                if (!empty($msg)) {
                                    echo '<div class="form-group">';
                                    echo '<p class="text-success text-center mt-2 mb-4" style="font-size:16px;">' . $msg . '</p>';
                                    echo '</div>';
                                }
                                ?>
                                <div class="form-label-group">
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" name="nama" id="inputNama" required />
                                    <label for="inputNama">Nama Lengkap</label>
                                </div>
                                <div class="form-label-group">
                                    <input type="text" class="form-control" placeholder="No. Handphone" name="nope" id="inputNope" required />
                                    <label for="inputNope">No. Handphone</label>
                                </div>
                                <div class="form-label-group">
                                ...
                                <input class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="daftar" value="Daftar">
                            </form>
                        </div>
                    </div>
                </div>
