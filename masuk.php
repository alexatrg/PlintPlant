    ...
    <div class="top-bar">
        <div class="container">
            <div class="content-holder d-flex justify-content-between">
                ...
                <div class="CTAs">
                    <a href="masuk.php" class="login"><i class="fa fa-sign-in"></i><span
                            class="d-none d-md-inline ">Masuk</span></a>
                    <a href="daftar.php" class="login"> <i class="fa fa-user"></i><span
        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center text-dark">Masuk PlintPlant</h5>
                        <form class="form-signin" action="masuk.php" method="post">
                            ...
                            <div class="form-label-group">
                                ...
                                <?php
                                if (!empty($msg)) {
                                    echo '<p class="text-danger text-center mt-2 mb-4" style="font-size:16px;">' . $msg . '</p>';
                                }
                                ?>
                            </div>
                            <input class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="masuk" value="Masuk">
                        </form>
                    </div>
                </div>
            </div>
